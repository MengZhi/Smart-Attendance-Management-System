...
namespace Version20140107.Account
{
    public partial class SetClassForOneLecturer : System.Web.UI.Page
    {
        ...
        protected void GridView2_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string ClassDate = ((TextBox)GridView2.Rows[e.RowIndex].FindControl("tbClassDate")).Text;
            ...
            string ClassId = GridView2.DataKeys[e.RowIndex].Value.ToString();

            string sqlstr = "update classinfo set Semester=@Semester, TeachingYear=@TeachingYear,BuildingNumber=@BuildingNumber,ClassDate=@ClassDate,StartTime=@StartTime,EndTime=@EndTime where ClassId=@ClassId;";
            MySqlCommand sqlcom = new MySqlCommand(sqlstr, cn);
