...
{
    public partial class StudentAttentDetail : System.Web.UI.Page
    {
        ...
        public void GetSummary()
        {
            ...
            cn2.Open();
            dataCommand1.Parameters.AddWithValue("@StudentId", GetStudentId(Session["UserName"].ToString()));
            dataCommand1.Parameters.AddWithValue("@ClassId", GetClassId());

            summary.Text = "Time of you staying in classroom: " + Convert.ToString(dataCommand1.ExecuteScalar());
            cn2.Close();
        }
