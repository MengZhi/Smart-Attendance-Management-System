...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" ControlToValidate="CardID"
                ForeColor="Red"
                runat="server" ToolTip="E-mail is required."
                ValidationGroup="PersonalInfoGroup">Please obtain the card ID</asp:RequiredFieldValidator>
            <asp:Button ID="GetCardID" runat="server" Text="Obtain Card ID" OnClick="GetCardID_Click" />
