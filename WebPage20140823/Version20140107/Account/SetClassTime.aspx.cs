...
namespace Version20140107.Account
{
    public partial class SetClassTime : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string sqlstr = "update classinfo set Semester=@Semester, TeachingYear=@TeachingYear,RoomNumber=@RoomNumber,BuildingNumber=@BuildingNumber,ClassDate=@ClassDate,StartTime=@StartTime,EndTime=@EndTime where ClassId=@ClassId;";
            MySqlCommand sqlcom = new MySqlCommand(sqlstr, cn);
