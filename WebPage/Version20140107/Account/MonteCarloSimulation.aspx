...
<body>
    ...
    <asp:DropDownList ID="StudentBatch" runat="server">
        ...
        <div>
            ...
            Show the Log of Student Generation:
            <asp:Button ID="Refresh" runat="server" Text="Log" OnClick="Refresh_Click" />
            </br>
           <div>
               <a href="AdminWelcome.aspx">
                   <asp:Label ID="Label1" Text='Home Page' runat="server" />
               </a>
           </div>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Register Course">
                        <ItemTemplate>
                            <asp:Button ID="RegisterCourse" Text="Register Course" runat="server" OnClick="RegisterCourse_Click1" />
                        </ItemTemplate>
