...
namespace Surface_RFID_SAS.LecCheckAttendance
{
    ...
    public sealed partial class Default : Page
    {
        ...
        string ClassDate = (string)Windows.Storage.ApplicationData.Current.LocalSettings.Values["ClassDate"];
        ...
        public Default()
        {
            ...
            this.ClassList.SelectionChanged += itemListView_SelectionChanged;
        ...
        void itemListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            Windows.Storage.ApplicationData.Current.LocalSettings.Values["ClassTime"] = mySelectedItem.starttime+"-"+mySelectedItem.endtime;
            Windows.Storage.ApplicationData.Current.LocalSettings.Values["BuildingNumber"] = mySelectedItem.buildingNumber;
            Windows.Storage.ApplicationData.Current.LocalSettings.Values["RoomNumber"] = mySelectedItem.roomNumber;

            ClassDate = (string)Windows.Storage.ApplicationData.Current.LocalSettings.Values["ClassDate"];
        ...
        void ItemListView_SelectionChanged2(object sender, SelectionChangedEventArgs e)
        {
            ...
            Windows.Storage.ApplicationData.Current.LocalSettings.Values["MatricNumber"] = mySelectedItem.matricNumber;

            this.Frame.Navigate(typeof(LecCheckMovement.Default));
        ...
        public void GetStuAttendanceList()
        {
            ...
            var lsdStdentList = proxy.GetLecStudentAttendanceAsync(LecTeachingYear, LecSemester, LecCourseCode, ClassDate).Result.ToList();
        ...
        {
            Service1Client proxy = new Service1Client();
            var lsdClassList = proxy.GetLecturerClassListAsync(LecSemester, LecTeachingYear, LecCourseCode).Result.ToList();
        ...
        {
            if (this.UsingLogicalPageNavigation() && this.ClassList.SelectedItem != null)
            {
                return true;
            }
            else
        ...
        private void GoBack()
        {
            if (this.UsingLogicalPageNavigation() && this.ClassList.SelectedItem != null)
            {
                ...
                // navigation.
                this.ClassList.SelectedItem = null;
            }
            else
            {
        ...
        private string DetermineVisualState()
        {
            ...
            var logicalPageBack = this.UsingLogicalPageNavigation() && this.ClassList.SelectedItem != null;
        ...
        {
            this.Frame.Navigate(typeof(ClassStatistic.Default));
        }
    }
