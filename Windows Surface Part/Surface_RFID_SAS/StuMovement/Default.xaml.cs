...
namespace Surface_RFID_SAS.StuMovement
{
    ...
    public sealed partial class Default : Page
    {
        ...
        string newclassdate = (string)Windows.Storage.ApplicationData.Current.LocalSettings.Values["ClassDate"];
        ...
        public Default()
        {
            ...
            this.ClassList.SelectionChanged += itemListView_SelectionChanged1;
        ...
        public void GetMovementStatusList()
        {
            ...
            var lsdMovementList = proxy.GetStudentMovementAsync(StuEmail, StuSemester, StuTeachingYear, StuCourseCode, newclassdate).Result.ToList();
        ...
        public async void GetClassSummary()
        {
            Service1Client proxy = new Service1Client();
            string result = await proxy.GetSummaryAsync(StuEmail, StuSemester, StuTeachingYear, StuCourseCode, newclassdate);
            summary.Text = result;
        ...
        private void ItemListView_SelectionChanged1(object sender, SelectionChangedEventArgs e)
        {
