...
namespace Surface_RFID_SAS.LecChooseCourseClass
{
    ...
    public sealed partial class Default : Page
    {
        ...
        private void ItemListView_SelectionChanged2(object sender, SelectionChangedEventArgs e)
        {
            if (this.UsingLogicalPageNavigation())
            {
                this.navigationHelper.GoBackCommand.RaiseCanExecuteChanged();
            ...
            this.Frame.Navigate(typeof(LecCheckAttendance.Default));
        }

        public void GetLecCourseList()
        {
            string LecEmail = (string)Windows.Storage.ApplicationData.Current.LocalSettings.Values["UserName"];
            Service1Client proxy = new Service1Client();
            var lsdCourseList=proxy.GetLecCourseListAsync(LecEmail).Result.ToList();
        ...
        {
            string LecEmail = (string)Windows.Storage.ApplicationData.Current.LocalSettings.Values["UserName"];
            string LecCourseName = (string)Windows.Storage.ApplicationData.Current.LocalSettings.Values["CourseName"];
