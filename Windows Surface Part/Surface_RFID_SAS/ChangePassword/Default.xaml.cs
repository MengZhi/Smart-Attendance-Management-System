...
namespace Surface_RFID_SAS.ChangePassword
{
    ...
    public sealed partial class Default : Page
    {
        ...
        public async void  ChangePassword()
        {
            ...
            string username = (string)Windows.Storage.ApplicationData.Current.LocalSettings.Values["UserName"];
            //ErrorMessage.Text = username;

            int result = await proxy.ChangePasswordAsync(OldPassword.Password, NewPassword.Password, ReNewPassword.Password, username);
